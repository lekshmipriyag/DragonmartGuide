...
if($_SESSION['live_user_type'] === "adminuser" && in_array('shop_new', $permission_set)){
		
	
	$no_result = mysqli_query( $db, "SELECT * FROM `shop_number` WHERE `sno_shopid`='0' AND `sno_status`='on' ORDER BY `shop_number`.`sno_number` ASC ");
	while($noRow = mysqli_fetch_array( $no_result )){
		//$shopno[$noRow['sno_shopid']] = "'".$noRow['sno_number']."'";
		$shopno[] = "'".$noRow['sno_number']."'";
	}
}else{
...
<head>
	<meta charset="utf-8">
	<title>Shop Creation :: Dragon Mart Guide</title>
			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
				...
				<div class="row">
					<div class="col-lg-12 C-main">
						<div class="row">
							<div class="C-dash1">New Shop</div>
							<div class="C-dash2">Create New Shop</div>
						</div>
						<div class="row">
								...
								<form name="shopForm" id="shopForm" method="post" enctype="multipart/form-data">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											...
											<input class="form-control" id="comp_name" name="comp_name" type="text" value="" required="required"/>
										</div>
										<div class="form-group">
											...
											?>
											<input name="comp_no" id="input22" class="select2-select-02 col-md-12 full-width-fix" multiple data-placeholder="Type to add a Tag" type="hidden" value="" required="required" >
										...
										<div class="form-group">
											...
											<select class="form-control" id="comp_location" name="comp_location" required>
												...
												<option value="Dragon Mart 1">Dragon Mart 1</option>
												<option value="Dragon Mart 2">Dragon Mart 2</option>
											</select>
										</div>
										<div class="form-group">
										...
										<div class="form-group " style="margin-bottom:90px !important;;">											
											...
											<input class="form-control" id="comp_zone" name="comp_zone" type="text" value="" placeholder="eg.GB, BA"/>
											
											</div>
											<div class="col-md-6" style="padding-left: 5px; padding-right: 0px;">
											<label for="comp_parking">Nearest Entrance </label>
											<input class="form-control" id="comp_parking" name="comp_parking" type="text" value="" placeholder="eg. Gate 1, Gate 2 (Use comma)"/>
											</div>	
										</div>
										...
										<div class="form-group">
											...
											<input class="form-control" id="comp_landmart" name="comp_landmart" type="text" value=""/>
										</div>
										<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											...
											<input class="form-control" id="comp_person" name="comp_person" type="text" required="required" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_primary"> Primary Contact (Office Use) </label>
											<div class="input-group"> <span class="input-group-addon">+971</span>
												<input class="form-control" id="comp_primary" name="comp_primary" type="tel" pattern=".[0-9].{8, 14}" required="required" value=""/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group"> <span class="input-group-addon">+971</span>
												<input class="form-control" id="comp_contact1" name="comp_contact1" type="tel" aria-label="contact1" value=""/>
												<span class="input-group-addon RckMsg">
													

													<input type="checkbox" name="comp_contact1Wa" aria-label="contact1" title="Whatsapp" style="vertical-align: middle;" >
													<img src="../images/whatsapp-icon1.png" width="20" height="20" alt="Whatsapp" title="Whatsapp"/>
													<input type="checkbox" name="comp_contact1Wc" aria-label="contact1" title="WeChat" style="vertical-align: middle;" >
										...
										<div class="form-group">
											...
											<div class="input-group"> <span class="input-group-addon">+971</span>
												<input class="form-control" id="comp_contact2" name="comp_contact2" type="tel" aria-label="contact2" value=""/>
												<span class="input-group-addon RckMsg">
                <input type="checkbox" name="comp_contact2Wa" aria-label="contact2" title="Whatsapp" style="vertical-align: middle;" >
                <img src="../images/whatsapp-icon1.png" width="20" height="20" alt="Whatsapp" title="Whatsapp" />
                <input type="checkbox" name="comp_contact2Wc" aria-label="contact2" title="WeChat" style="vertical-align: middle;" >
                <img src="../images/wechat-logo.png" width="20" height="20" alt="WeChat" title="WeChat" /> </span>
										...
										<div class="form-group">
											...
											<div class="input-group"> <span class="input-group-addon">+971</span>
												<input class="form-control" id="comp_tel" name="comp_tel" type="tel" value=""/>
											</div>
										</div>
										<div class="form-group">
											<label for="comp_email"> Email </label>
											<input class="form-control" id="comp_email" name="comp_email" type="email" required="required" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_website"> Website </label>
											<input class="form-control" id="comp_website" name="comp_website" type="url" value=""/>
										</div>
										<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											...
											<input class="form-control" id="comp_twitter" name="comp_twitter" type="url" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_facebook"> Facebook </label>
											<input class="form-control" id="comp_facebook" name="comp_facebook" type="url" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_instagram"> Instagram </label>
											<input class="form-control" id="comp_instagram" name="comp_instagram" type="url" value=""/>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="comp_google"> Google+ </label>
											<input class="form-control" id="comp_google" name="comp_google" type="url" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_pinterest"> Pinterest </label>
											<input class="form-control" id="comp_pinterest" name="comp_pinterest" type="url" value=""/>
										</div>
										<div class="form-group">
											<label for="comp_youtube"> Youtube </label>
											<input class="form-control" id="comp_youtube" name="comp_youtube" type="url" value=""/>
										</div>
									</div>
									<!-- Social end -->
									<!-- Shop service start -->
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											...
											<label for="cash">
                <input type="checkbox" name="cash" id="cash" value="Cash" />
                Cash</label>
                ...
                Cheque</label>
											...
											<label for="cards">
                <input type="checkbox" name="cards" id="cards" value="Cards" />
                Cards</label>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<br/>
											<label for="cash">
                <input type="radio" name="delivery" id="delivery_1" value="Yes" />
                Yes</label>
										

											<label for="cheque">
                <input type="radio" name="delivery" id="delivery_2" value="No" />
                No</label>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<div class="testimg1" id="testimg1">
												<img id="bannerimg1" class="testimage" src="">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<div class="testimg1" id="testimg2">
												<img id="bannerimg2" class="testimage" src="">
											</div>
										</div>
									</div>
									<script>
    ...
    do {
        ...
        $li = $chk.closest('li');
              ...
              <!-- category row end --> 
								...
								<input type="hidden" name="shopnos_old" value=""  />
								<input type="hidden" name="shopstatus" value="" />
									</div>
								</form>
							</div>
						</div>
