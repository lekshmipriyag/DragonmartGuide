				  ...
				  foreach($filteredArray2 as $cate_fmain2){
					  ...
					  foreach($filteredArray3 as $cate_flist2){
						  if($cate_flist2['cate_list'] != "999" && $cate_flist2['cate_main'] = $cate_fmain2['cate_main'] && $cate_flist2['cate_parent'] = $cate_fmain2['cate_parent']){ 
							  ...
							  echo "<input name='cate[]' type='checkbox' value='".$cate_flist2['id']."'";
							  ?>
    ...
    do {
        ...
        $li = $chk.closest('li');
              ...
              <!-- category row end --> 
									...
									<div class="col-lg-12">
									<input type="hidden" name="bannerimgold" value="<?php echo $shopRow['shop_picture']; ?>" />
									<input type="hidden" name="logoimgold" value="<?php echo $shopRow['shop_logo']; ?>" />
									<?php
									$token = uniqid( '', true );
