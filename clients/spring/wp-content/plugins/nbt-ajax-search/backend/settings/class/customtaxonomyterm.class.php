<?php
if (!class_exists("wpnetbaseCustomTaxonomyTerm")) {
    /**
     * Class wpnetbaseCustomTaxonomyTerm
     *
     ...
     */
    class wpnetbaseCustomTaxonomyTerm extends wpnetbaseType {
        function getType() {
            parent::getType();
            $this->processData();
            $this->types = $this->getAllTerms();
            echo "
      <div class='wpnetbaseCustomTaxonomyTerm' id='wpnetbaseCustomTaxonomyTerm-" . self::$_instancenumber . "'>
        <fieldset>                               
         ...
         <input type='hidden' value='wpnetbaseCustomTaxonomyTerm' name='classname-" . $this->name . "'>";
            echo "
        </fieldset>
      </div>";
        }
