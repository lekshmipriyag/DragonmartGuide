<?php
if (!class_exists("wpnetbaseLabelPosition")) {
    /**
     * Class wpnetbaseLabelPosition
     *
     * DEPRECATED
     *
     * @deprecated
     ...
     */
    class wpnetbaseLabelPosition extends wpnetbaseType {
      ...
      ";
            ...
            new wpnetbaseSelect("indirection_" . $this->name, "Animation direction", $this->_direction);
            new wpnetbaseText("induration_" . $this->name, "Animation duration (ms)", $this->duration);
            echo "</div>";
            echo "
        </div>
