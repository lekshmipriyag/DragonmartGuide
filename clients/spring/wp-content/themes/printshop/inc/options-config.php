            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        'options'   => array(
                            'header-default' => array('alt' => 'Header Default', 'img' => get_template_directory_uri() . '/images/imgs_option/h3.jpg'),
                            'logoleft' => array('alt' => 'Logo Left', 'img' => get_template_directory_uri() . '/images/imgs_option/h2.jpg'),
                            'centered' => array('alt' => 'Centered', 'img' => get_template_directory_uri() . '/images/imgs_option/h1.jpg'),
                            'banner' => array('alt' => 'Img Background', 'img' => get_template_directory_uri() . '/images/imgs_option/h6.jpg'),
                        ),
                        ...
                        array(
                            ...
                            'default'  => '',
                            'output'   => array(
                                'background-color'             => '.menu-logo'
                            ),
                            'required' => array('header_style','=','banner', ),
                        ),
                        array(
                            'id'       => 'text_value_color',
                            'type'     => 'color',
                            ...
                            'default'  => '',
                            'output'   => array(
                                'color'             => '.header-banner #mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link, .header-banner .header-cart-search .cart-contents, .header-banner form.search-form::after,
                                    .header-banner #netbase-responsive-toggle, 
                                    .header-banner .header-search .fa-search'
                            ),
                            'required' => array('header_style','=','banner', ),
                        ),
                        array(
                            'id'       => 'homepage_layout',
                            'type'     => 'button_set',
                            'title'    => esc_html__( 'HomePage Content Layout', 'printshop' ),
                            'subtitle' => esc_html__( 'Select your home content layout', 'printshop' ),
                            'options'  => array(
                                'home-default'  => 'Home Default',
                                'home-slider'   => 'Home Slider',
                                'home-boxed' => 'Home Boxed',
                            ),
                        ...
                        array(
                            'id'       => 'header_social',
                            'type'     => 'switch',
                            'title'    => esc_html__('Enable header social icon', 'printshop'),
                            'default'  => true,
                        ...
                        array(
                            ...
                            'type'     => 'checkbox',
                            'title'    => esc_html__('Select Header Social Icon?', 'printshop'),
                        ...
                        array(
                            ...
                            'type'     => 'background',
                            'compiler' => true,
                            'output'   => array('.site-topbar, .sidebar-header-cs .widget-woocommerce-currency-switcher select'),
                        ...
                        array(
                            ...
                            'output'   => array(
                                ...
                                .woocommerce-currency-switcher-form a span,.header-social a, #topbar-boxed-acc a'
                            )
                        ),
                        array(
                            ...
                            'default'  => '',
                            'output'   => array(
                                'color'             => '.site-topbar a:hover, #topbar-boxed-acc a:hover'
                            )
                        ),
                        array(
                        ...
                        array(
                            ...
                            'default'  => '',
                            'output'   => array(
                                'color'             => '.header-search .fa-search,form.search-form::after, #mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link, .header-cart-search .cart-contents, .header-right-wrap, .site-header .header-right-wrap .header-social a i',
                    ...
                    'fields' => array(
                        array(
                            ...
                            'color' => '
                                ...
                                .wpb_wrapper .wpc-projects-dark .esg-cartbutton-order:hover, .wpb_wrapper .wpc-projects-dark .esg-filterbutton.selected',
                                
                            'background-color'  => '#secondary .widget-title,.paging-navigation .page-numbers.current,
                            ...
                            'border-right-color' => '.swiper-wrapper .brand-slide-item:after',
                            'border-left-color' => '
                        ...
                        array(
                            ...
                            'color'            => '.secondary-color,
								...
								'border-bottom-color' =>'.single-product #primary .woocommerce-tabs ul.tabs li.active:after',
                                'background-color' => '.woocommerce ul.products.list li.product .product-list-content-info .gridlist-buttonwrap a.add_to_cart_button,
