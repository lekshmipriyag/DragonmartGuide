...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="total"><strong><?php esc_html_e( 'Subtotal', 'printshop' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

	<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

	<p class="buttons">
		<a href="<?php echo esc_url(WC()->cart->get_cart_url()); ?>" class="button wc-forward"><?php esc_html_e( 'View Cart', 'printshop' ); ?></a>
		<a href="<?php echo esc_url(WC()->cart->get_checkout_url()); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'printshop' ); ?></a>
	</p>
