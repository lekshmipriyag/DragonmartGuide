      ...
      <div class="col-lg-3 col-md-3"><!-- widgets column left -->
        <ul class="list-unstyled clear-margins">
          ...
          <li class="widget-container widget_nav_menu"><!-- widgets list -->
            ...
            <ul style="color:gold;">
              <li><a class="Rblink" href="http://www.trakhees.ae" target="_blank"><i class="fa fa-angle-double-right"></i> Trakhees</a></li>
              <li><a  class="Rblink" href="http://www.nakheel.com" target="_blank"><i class="fa fa-angle-double-right"></i> Nakheel</a></li>
              <li><a  class="Rblink" href="http://www.nakheel.com/en/corporate/our_divisions/
retail-corp" target="_blank"><i class="fa fa-angle-double-right"></i> Retail Corp</a></li>
              <li><a  class="Rblink" href="http://www.dubaided.gov.ae" target="_blank"><i class="fa fa-angle-double-right"></i> DED</a></li>
              <li><a  class="Rblink" href="http://www.thedubaimall.com" target="_blank"><i class="fa fa-angle-double-right"></i> Dubai Mall</a></li>
              <li><a  class="Rblink" href="http://www.malloftheemirates.com" target="_blank"><i class="fa fa-angle-double-right"></i> Mall of the Emirates</a></li>
              <li><a  class="Rblink" href="http://www.rakbank.ae" target="_blank"><i class="fa fa-angle-double-right"></i> RAK Bank</a></li>
              <li><a  class="Rblink" href="http://www.emiratesnbd.com" target="_blank"><i class="fa fa-angle-double-right"></i> Emirates NBD Bank</a></li>
            </ul>
          </li>
        </ul>
      </div>
        ...
        <ul class="list-unstyled clear-margins">
          ...
          <li class="widget-container widget_recent_news"><!-- widgets list -->
            ...
            <div class="footerp">
              ...
              <p class="Rbaddress"><b>Helpline Numbers (8AM to 10PM):</b>+971 50 148 6343 </p>
...
<div class="footer-bottom">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="design"> <a target="_blank" href="http://www.massdubai.com">Web design by Mass publishing LLC</a> </div>
      </div>
    </div>
  </div>
</div>
