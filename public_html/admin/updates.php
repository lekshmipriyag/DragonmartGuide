...
if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=="true")){
  ...
  $logoutGoTo = "../../../beta.Dragonmartguide.com/public_html/login.php";
  if ($logoutGoTo) {
...
$page_name = "updates";
include('../../../beta.Dragonmartguide.com/public_html/Connections/permission.php');
?>
<?php
if (!isset($_SESSION)) {
  session_start();
...
$MM_restrictGoTo = "../../../beta.Dragonmartguide.com/public_html/login.php";
...
?>
<?php
include( '../../../beta.Dragonmartguide.com/public_html/Connections/dragonmartguide.php' );
include( '../../../beta.Dragonmartguide.com/public_html/Connections/functionsL.php' );
...
<head>
	...
	<link type="text/css" rel="stylesheet" href="../../../beta.Dragonmartguide.com/public_html/css/bootstrap.min.css">
<!--	<link type="text/css" rel="stylesheet" href="../css/clientstyle.css">-->
	<link rel="stylesheet" href="../../../beta.Dragonmartguide.com/public_html/css/font-awesome.min.css">
	<style type="text/css">
	...
	<!-- DataTables -->
	<link type="text/css" rel="stylesheet" href="../../../beta.Dragonmartguide.com/public_html/datatable/dataTables.bootstrap.min.css">
	<link type="text/css" rel="stylesheet" href="../../../beta.Dragonmartguide.com/public_html/datatable/responsive.bootstrap.min.css">
	<script type="text/javascript" src="../../../beta.Dragonmartguide.com/public_html/datatable/jquery.dataTables.min.js"></script> 
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="../../../beta.Dragonmartguide.com/public_html/datatable/dataTables.responsive.min.js"></script>
	<script type="text/javascript" src="../../../beta.Dragonmartguide.com/public_html/datatable/responsive.bootstrap.min.js"></script>
	<script type="text/javascript" src="../../../beta.Dragonmartguide.com/public_html/admin/js/jquery-confirm.min.js"></script>
<!--	<script type="text/javascript" src="js/jquery.mobile-1.1.1.js"></script>-->
	<!-- DataTables -->
	<link type="text/css" rel="stylesheet" href="../../../beta.Dragonmartguide.com/public_html/css/clientstyle.css">
	<style>
		.force-select {  
...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<?php include("../../../beta.Dragonmartguide.com/public_html/admin/shop_left_bar.php"); ?>
			</div>
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
				<?php include("../../../beta.Dragonmartguide.com/public_html/admin/shop_top_bar.php"); ?>
										...
										<?php }?>
											    ...
											    <td><?php 
												 $rowID = $updateData['updt_rowid'];
														...
														if($resultData!=''){ ?>
															<img src="<?php echo "../../../beta.Dragonmartguide.com/public_html/images/login".$resultData?>" alt="<?php echo $resultData?>" style="width:100px;height:100px;">
															<?php }else{
...
<?php include('../../../beta.Dragonmartguide.com/public_html/admin/shop_footer.php'); ?>
<script>
