			...
			<div class="col-md-8 col-sm-8 col-xs-12">
				...
				<div class="row" id="row">
					<div class="col-md-12 col-sm-12 col-xs-12 RsrchListM">
						<div class="col-md-2 col-sm-2 col-xs-6"><a href="#" class="thumbnail"><img src="images/images-others/rak-bank-atm.jpg" alt="Rak Bank"/></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-6"><a href="#" class="thumbnail">RAK Bank Branch & ATM</a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-6"><a href="#" class="thumbnail">Dragon mart 1, First floor, left side, Parking EB is near</a>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-6"><a href="#" class="thumbnail"><img src="images/images-others/location.jpg" alt="location"/></a>
						</div>
<style>
...
<!--
						<div class="col-md-8 col-sm-8 col-xs-12">
							<header>
								<span class='Rheartf'><i class='fa fa-heart' aria-hidden='true' title='My Favorite'></i></span> <a title='Product Name' href='#'>product name</a> |
								<a title="Shop Name" href="#">Shop Name</a> <span class="btn btn-default" style="padding: 0 5px !important;" title="Dragon mart 2">DM2</span>
							</header>
							<p>description ...</p>
							<pre>location details</pre>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-12">
							<p>Views (15)</p>
							<p>stars </p>
							<p>review counts</p>
							<a title='View product details' href='#'><button class='btn btn-primary Rsrsulbtn' value='View More...'>View More</button></a>
						</div>
-->
					</div>
				</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 RsrchListM">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
							...
							<header>
								...
								if ( $row[ 'shop_mall' ] == 'Dragon Mart 1' ) {
									$dmg = 'DM1';
								} elseif ( $row[ 'shop_mall' ] == 'Dragon Mart 2' ) {
									$dmg = 'DM2';
								}
								?>
								<a title="Shop Name" href="companydetails.php?sh=<?php echo $row['shop_id']; ?>">
									<?php echo strip_tags($row['shop_name']); ?>
								</a>
								<span class="btn btn-default" style="padding: 0 5px !important;" title="<?php echo $row['shop_mall']; ?>">
									<?php echo $dmg; ?>
								</span>
							</header>
							<?php
							if ( isset( $row[ 'prodt_description' ] ) && $row[ 'prodt_description' ] != '' ) {
								...
								echo "<p>" . substr( strip_tags( $row[ 'shop_description' ] ), 0, 150 ) . "...</p>";
							}
							?>

							<?php

							if ( isset( $row[ 'prodt_category' ] ) ) {
								$catePrint = json_decode( $row[ 'prodt_category' ], true );
							}

							if ( isset( $catePrint ) ) {
								echo "<pre>";
								foreach ( $catePrint as $key => $cateArray ) {
									if ( isset( $cateArray[ 'cate_level' ] ) ) {
										$catLevel = $cateArray[ 'cate_level' ];
									} else {
										$catLevel = '';
									}

									if ( $catLevel == 2 ) {
										echo $cateArray[ 'cate_main' ] . ", ";
									} elseif ( $catLevel == 3 ) {
										echo $cateArray[ 'cate_list' ] . ", ";
									}
								}
								echo "</pre>";
							}
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<p>Views (
								<?php if(isset($row['prodt_views_count'])){echo $row['prodt_views_count'];}else{echo '0';} ?>)</p>
							<p>
