...
function wpnetbaseuploader(args)  {  

  this.constructor = function() {

    this.buttons = jQuery('.wpnetbaseUpload_button');
    ...
    jQuery('input.wpnetbaseUpload').change(function() {
  ...
  this.init = function() {
    ...
    jQuery('input[name="default"]').click(function(){
      ...
      jQuery('input.wpnetbaseUpload').trigger("change");
