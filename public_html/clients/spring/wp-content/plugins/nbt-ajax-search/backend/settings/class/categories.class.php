<?php
if (!class_exists("wpnetbaseCategories")) {
    /**
     * Class wpnetbaseCategories
     *
     ...
     */
    class wpnetbaseCategories extends wpnetbaseType {
        function getType() {
            parent::getType();
            global $wpdb;
            $this->processData();
            ...
            echo "
      <div class='wpnetbaseCategories' id='wpnetbaseCategories-" . self::$_instancenumber . "'>
        <fieldset>
         ...
         <input isparam=1 type='hidden' value='" . $this->data . "' name='" . $this->name . "'>";
            echo "
         <input type='hidden' value='wpnetbaseCategories' name='classname-" . $this->name . "'>";
            echo "
        </fieldset>
      </div>";
        }
