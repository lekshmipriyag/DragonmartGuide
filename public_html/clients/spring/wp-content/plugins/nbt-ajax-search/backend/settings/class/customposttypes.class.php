<?php
if (!class_exists("wpnetbaseCustomPostTypes")) {
    /**
     * Class wpnetbaseCustomPostTypes
     *
     ...
     */
    class wpnetbaseCustomPostTypes extends wpnetbaseType {
        function getType() {
            parent::getType();
            $this->processData();
            ...
            echo "
      <div class='wpnetbaseCustomPostTypes' id='wpnetbaseCustomPostTypes-" . self::$_instancenumber . "'>
        <fieldset>
         ...
         <input isparam=1 type='hidden' value='" . $this->data . "' name='" . $this->name . "'>";
            echo "
         <input type='hidden' value='wpnetbaseCustomPostTypes' name='classname-" . $this->name . "'>";
            echo "
        </fieldset>
      </div>";
        }
