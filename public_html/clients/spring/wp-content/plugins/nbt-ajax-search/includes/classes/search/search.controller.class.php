...
if (!class_exists('asl_searchController')) {
    ...
    class asl_searchController {
        ...
        public function search() {
            ...
            $_posts = new wpnetbase_searchContent($params);
        ...
        private function parseOptions() {
            ...
            switch ($sd['resultstype']) {
                case "horizontal":
                    ...
                    $sd['image_options']['image_width'] = wpnetbase_width_from_px($sd['image_options']['hreswidth']);
                    $sd['image_options']['image_height'] = wpnetbase_width_from_px($sd['image_options']['hreswidth']);
                    break;
                case "polaroid":
