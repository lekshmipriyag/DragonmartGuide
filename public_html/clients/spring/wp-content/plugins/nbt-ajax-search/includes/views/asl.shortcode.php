...
?>
<div id='ajaxsearchlite<?php echo self::$instanceCount; ?>' class="wpnetbase_asl_container">
<div class="probox">
...
<div id='ajaxsearchlitesettings<?php echo $id; ?>' class="searchsettings wpnetbase_asl_settings">
    <form name='options'>
...
<div id='ajaxsearchliteres<?php echo $id; ?>' class='<?php echo $style['resultstype']; ?> wpnetbase_asl_results'>
...
<?php else: ?>
<div class="asl_init_data wpnetbase_asl_data_ct" style="display:none !important;" id="asl_init_id_<?php echo $id; ?>" data-asldata="<?php echo base64_encode($_asl_script_out); ?>"></div>
<?php endif; ?>