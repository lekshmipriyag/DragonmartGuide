...
class wpnetbase_sale_off_widget extends WP_Widget 
{
	function __construct() 
	{
		...
		__('NBT Woocommerce Sale Off', 'wpb_widget_domain'), 
	...
	public function widget( $args, $instance )
	{
		...
		<div class="recent-products woocommerce">
			<h2 class="recent-products-heading"><?php echo $title; ?></h2>  
				<ul id="<?php echo 'nbt_sale_product'.$instance['panels_info']['id']; ?>" class="products owl-carousel" style="display:block;">
				<?php
				...
				jQuery(document).ready(function(){
					...
					jQuery('.panel-grid').each(function(){
						...
						else if (get_length == 4)
						{
							...
							jQuery(this).find('#nbt_sale_product'+<?php echo $instance['panels_info']['id']; ?>).owlCarousel({								
								items:item_count,								
								autoPlay: 3000, 								
								lazyLoad : true,								
								navigation : true,								
