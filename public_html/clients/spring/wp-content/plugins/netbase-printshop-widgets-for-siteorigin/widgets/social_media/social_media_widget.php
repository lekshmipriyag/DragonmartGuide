...
class wpnetbase_social_media_widget extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('socialicon'); ?>"><?php _e( 'Social Icon', 'wpnetbase' ); ?>:</label>
            <select class='widefat' id="<?php echo $this->get_field_id('socialicon'); ?>" name="<?php echo $this->get_field_name('socialicon'); ?>" type="text">
                  <option value='font'<?php echo ($socialicon=='font')?'selected':''; ?>>
                    <?php _e( 'font', 'wpnetbase' ); ?>
                  </option>
                  <option value='images'<?php echo ($socialicon=='images')?'selected':''; ?>>
                    <?php _e( 'images', 'wpnetbase' ); ?>
                  </option> 
