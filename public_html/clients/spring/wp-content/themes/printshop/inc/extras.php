...
function printshop_body_classes($classes ) {
	...
	if ( printshop_get_option('homepage_layout') && printshop_get_option('homepage_layout') !== '' ) {
		$classes[]= printshop_get_option('homepage_layout');
	}else{
...
add_action('wp_footer', 'init_product_zoom', 50);
