					...
					<div class="inner-settings-wrapper">
						<div id="tp-idle-state-advanced-style" style="float:left; padding-left:20px;">
							...
							<ul class="rs-layer-animation-settings-tabs" style="display:inline-block; ">
								...
								<li id="_layer_hover_style_menu" data-content="#style-sub-hover"><?php _e("Hover",'revslider'); ?></li>
								<li id="_layer_toggle_style_menu" data-content="#style-sub-toggle"><?php _e("Toggle",'revslider'); ?></li>		
							</ul>
